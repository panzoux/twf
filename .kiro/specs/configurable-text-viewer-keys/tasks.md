...
- [ ] 1. Update KeyBindingManager to support mode-specific bindings
...
- [ ] 3. Add TextViewer action methods to TextViewerWindow
...
- [ ] 4. Refactor TextViewerWindow to use KeyBindingManager
...
- [ ] 9. Test configurable text viewer keybindings
